...
export const PARAMETRIC_MODELS: ModelConfig[] = [
  {
    id: 'openai/gpt-4o',
    name: 'GPT-4o',
    description: 'Strong all-round OpenAI model for CAD generation',
    provider: 'OpenAI',
    supportsTools: true,
  ...
  },
  {
    id: 'openai/gpt-4.1',
    name: 'GPT-4.1',
    description: 'Latest GPT-4.1 for reliable multi-step CAD work',
    provider: 'OpenAI',
    supportsTools: true,
    supportsThinking: false,
    supportsVision: true,
  },
  {
    id: 'openai/o4-mini',
    name: 'o4-mini',
    description: 'Faster reasoning model for complex CAD edits',
    provider: 'OpenAI',
    supportsTools: true,
